...
def update_envoie():
    ...
    argD = data.get('argD', None)
    argI = data.get('argI', None)
    debutDate = data.get('argSD', None)
    finDate = data.get('argED', None)
    argTPR = data.get('argTPR', None)
    argSL = data.get('argSL', None)
    argBE = data.get('argBE', None)
    argPsy = data.get('argPsy', None)
    argStrat = data.get('argStrat', None)
    argAnnEco = data.get('argAnnEco', None)
    argPos = data.get('argPos', None)
    argTypOrd = data.get('argTypOrd', None)
