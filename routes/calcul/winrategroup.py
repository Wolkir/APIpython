...
def calculate_winrate_group(data):
    ...
    for doc in documents:
        ...
        if profit > 0 and is_buy_order and identifier not in positivelong_identifiers:
            positivelong_profits_count += 1
            positivelong_identifiers.add(identifier)
        if profit > 0 and is_sell_order and identifier not in positiveshort_identifiers:
        ...
        if profit < 0 and is_buy_order and identifier not in negativelong_identifiers:
            negativelong_profits_count += 1
            negativelong_identifiers.add(identifier)
        if profit < 0 and is_sell_order and identifier not in negativeshort_identifiers:
