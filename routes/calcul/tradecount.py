...
@tradecount.route('/tradecount', methods=['POST'])  # Modifier 'GET' à 'POST'
def calculate_tradecount(data):
    ...
    # Si le trade est ouvert, vérifiez simplement le total des trades ouverts et fermés.
    if status == "open":
    ...
    # Si le trade est fermé, obtenez le dernier `trade_number` de la collection `close` pour cette date spécifique et ajoutez 1.
    else:
